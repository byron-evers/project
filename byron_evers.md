...
## Objective
Write a python function to calculate biometeorological time (BMT (T<sub>max</sub>, T<sub>min</sub>, L, *a*<sub>0</sub>,*b*<sub>0</sub> )), physiological days (Pdays) and growing degree days (GDD) for several UAV collection dates.
